...
void CNetClient::setNetSignalStateCallBack(int weeksec, int dropsec, NETFUNC_SIGNALSTRENGTH powerfulCallBack, NETFUNC_SIGNALSTRENGTH weekCallBack)
{
    m_Connection.setNetSignalStateCallBack(weeksec, dropsec, powerfulCallBack, weekCallBack);
}
