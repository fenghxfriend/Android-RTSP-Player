...
#include "TEE_ringbuffer.h"
#include "TEE_huffman.h"
...
typedef void (*NETFUNC_SIGNALSTRENGTH)();
...
public:
	...
	int m_Ack;
	int m_NumChunks;
	int m_DataSize;         //odd the packet head size 3
...
public:
    ...
    void setNetSignalStateCallBack(int weeksec, int dropsec, NETFUNC_SIGNALSTRENGTH powerfulCallBack, NETFUNC_SIGNALSTRENGTH weekCallBack);
    
private:
    int m_weekSec;
    int m_dropSec;
    bool m_isWeekSignal;
    int m_fineSignalCounter;
    NETFUNC_SIGNALSTRENGTH m_powefulSignalCallBack;
    NETFUNC_SIGNALSTRENGTH m_weekSignalCallBack;
};
