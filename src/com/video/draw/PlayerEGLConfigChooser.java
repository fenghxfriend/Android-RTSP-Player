...
public class PlayerEGLConfigChooser implements GLSurfaceView.EGLConfigChooser {

	public PlayerEGLConfigChooser(int r, int g, int b, int a, int depth, int stencil) {
		super();
		mRedSize = r;
		mGreenSize = g;
		mBlueSize = b;
